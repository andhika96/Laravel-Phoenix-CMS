    ...
    <div className="builder-shell">
      <header className="topbar">
        <div className="topbar-left">
          ...
          <div className="brand-copy"><strong>Phoenix</strong><span>Page Builder 2.4</span></div>
      ...
      <main className="workspace">
        <aside className="inspector">
          ...
          <div className="panel-scroll">
            ...
            {tab === "style" && <section className="panel-section first"><div className="section-title"><span>Style preview</span><i className="bi bi-chevron-up" /></div><p className="empty-tab-copy">Typography, colors, spacing, button Normal/Hover, dan modal styling akan mengikuti pola kontrol v2.4 pada implementasi produksi.</p><div className="style-swatch-row"><span>Text color</span><span className="swatch dark" />#292d32</div><div className="style-swatch-row"><span>Button</span><span className="swatch button" />#30343a</div></section>}
            {tab === "advanced" && <section className="panel-section first"><div className="section-title"><span>Advanced</span><i className="bi bi-chevron-up" /></div><p className="empty-tab-copy">Widget produksi tetap mewarisi margin, padding, motion effects, background, border, responsive visibility, attributes, dan custom CSS v2.4.</p></section>}
          </div>
        </aside>
