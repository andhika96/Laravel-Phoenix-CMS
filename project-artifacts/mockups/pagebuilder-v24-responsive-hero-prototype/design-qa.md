...
- Builder shell mengikuti bahasa visual Page Builder v2.4 yang sudah dipakai prototype: inspector putih, device switcher, live canvas, selection outline, dan decision bar.
...
- Custom attributes disimpan pada state prototype tetapi sengaja tidak dirender sampai sanitizer production v2.4 dipakai.
- Save dan Preview tetap disabled; tidak ada Page Builder data yang disimpan.
- Source produksi Page Builder v2.4 tidak diubah.
