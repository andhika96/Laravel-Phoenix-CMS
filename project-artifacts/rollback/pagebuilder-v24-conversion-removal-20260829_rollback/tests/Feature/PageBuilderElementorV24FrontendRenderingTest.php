    ...
    public function test_v24_renders_representative_layout_basic_general_and_pro_nodes(): void
    {
        ...
        $form = $this->renderNode([
            ...
            'settings' => [
                ...
                'importNodeKey' => 'import-node-form',
                'fields' => [
                    ['id' => 'email', 'label' => 'Email', 'type' => 'email', 'required' => true, 'sourceImportNodeKey' => 'import-node-email', 'sourceLabelImportNodeKey' => 'import-node-email-label'],
                ],
        ...
        $this->assertStringContainsString('data-pb-import-node="import-node-form"', $form);
        $this->assertStringContainsString('data-pb-import-node="import-node-email-label"', $form);
        $this->assertStringContainsString('data-pb-import-node="import-node-email"', $form);
