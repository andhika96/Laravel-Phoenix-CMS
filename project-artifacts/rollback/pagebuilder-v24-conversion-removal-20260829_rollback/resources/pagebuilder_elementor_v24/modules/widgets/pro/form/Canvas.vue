<template>
    ...
    >
        <form
            ...
            :data-pb-import-node="sourceImportNodeKey(s.importNodeKey)"
            class="pb-pro-form"
            :style="formStyle"
        ...
        >
            ...
            >
                <label
                    ...
                    :data-pb-import-node="sourceImportNodeKey(field.sourceLabelImportNodeKey)"
                    :style="[
                ...
                >
                    <input
                        ...
                        value="1"
                        :data-pb-import-node="sourceImportNodeKey(field.sourceImportNodeKey)"
...
export default {
    ...
    methods: {
        ...
        sourceImportNodeKey(value) {
            const raw = String(value || "").trim();
            return /^import-node-[A-Za-z0-9_-]+$/.test(raw) ? raw : null;
        },
