...
<div
	...
	@endforeach
>
	<{{ $tag }} class="{{ $titleClasses }}" style="{{ $typographyStyle() }}" @if(isset($advanced['attributes']['data-pb-import-node'])) data-pb-import-node="{{ e($advanced['attributes']['data-pb-import-node']) }}" @endif>
		@if($linkUrl !== '')
