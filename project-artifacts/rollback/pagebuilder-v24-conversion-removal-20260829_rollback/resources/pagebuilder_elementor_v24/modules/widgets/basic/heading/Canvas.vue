<template>
	<component :is="safeTag" :class="['el-widget-heading', 'elementor-heading-title', customClass]" :style="titleStyle" :data-pb-import-node="importNodeKey">
	...
	computed: {
		...
		titleStyle() {
			...
			return {
				...
				whiteSpace: this.settings.sourceLineBreaks ? 'pre-line' : undefined,
