...
namespace App\Http\Requests\Page_Builder_Elementor_V23;
...
class EditPageBuilderElementorV23Request extends FormRequest
{
	public function authorize(): bool
	{
		$page = $this->resolveRequestedPage();

		return ! $page || $page->editor_version === Page_Builder::EDITOR_VERSION_V23;
	}
