...
namespace App\Http\Controllers\Web\Experimental\Auth;
...
class Auth_Controller extends Controller
{
	...
	public function loginSplitLeft(Request $request)
	{
		if (Auth::check())
		{
			return redirect()->intended('/dashboard');
		...
		return view('experimental.auth.split_left.login');
	}

	public function loginSplitRight(Request $request)
	{
		if (Auth::check())
		{
			return redirect()->intended('/dashboard');
		...
		return view('experimental.auth.split_right.login');
	}

	public function signupSplitLeft(Request $request)
	{
		return view('experimental.auth.split_left.signup');
	}

	public function signupSplitRight(Request $request)
	{
		return view('experimental.auth.split_right.signup');
	}
	...
	public function forgotSplitLeft(Request $request)
	{
		if (Auth::check())
		{
			return redirect()->intended('/dashboard');
		...
		return view('experimental.auth.split_left.forgotpassword', ['durationCode' => strtotime($createCodeDuration)]);
	}

	public function forgotSplitRight(Request $request)
	{
		if (Auth::check())
		{
			return redirect()->intended('/dashboard');
		...
		return view('experimental.auth.split_right.forgotpassword', ['durationCode' => strtotime($createCodeDuration)]);
	}
	...
	public function resetpassword(Request $request)
	{
		...
		// 	return view('experimental.auth.default.resetpassword', ['data' => $getDetailUser]);
		// }
		...
		$data = 
		[
			'recovery_code' => 'TESTING'
		];

		$dynamicView = 'auth.'.custom_page_theme('resetPassword').'.resetpassword';

		return view($dynamicView, ['data' => $data]);
	}

	public function recoverySplitLeft(Request $request)
	{
		if (Auth::check())
		{
			return redirect()->intended('/dashboard');
		...
		// 	return view('experimental.auth.split_left.resetpassword', ['data' => $getDetailUser]);
		// }
		...
		return view('experimental.auth.split_left.resetpassword', ['data' => $data]);
	}

	public function recoverySplitRight(Request $request)
	{
		if (Auth::check())
		{
			return redirect()->intended('/dashboard');
		...
		return view('experimental.auth.split_right.resetpassword', ['data' => $data]);
	}
	...
	public function ensureIsNotRateLimited($request, $amount_ratelimit)
	{
