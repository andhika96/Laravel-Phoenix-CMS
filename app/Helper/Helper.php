...
class Helper
{
    ...
    public static function decodeBase64($base64, $path = "media", $filename = "tmp", $ext = null, $maxFileSize = 1): string
    {
        // Check if Intervention Image is available
        if (class_exists('Intervention\Image\Laravel\Facades\Image')) {
            return self::convertAndCompressWithIntervention($base64, $path, $filename, $ext, $maxFileSize);
        } else {
    ...
    private static function convertAndCompressWithIntervention($base64, $path, $filename, $ext, $maxSize = 1)
    {
    ...
    {
        return new Encrypter(env("KENTANG_SALT", "FRIEDFRICE:BAKEDPOTATO2024"), 'AES-256-CBC');
    }
