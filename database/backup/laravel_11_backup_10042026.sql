...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 10, 2026 at 07:36 AM
...
CREATE TABLE `lr_fm_api_keys` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Label/nama app yang pakai key ini',
  `key` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'API Key yang dikirim via ?fm_key= atau header X-FM-Key',
  `secret` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Optional secret untuk HMAC signing',
...
CREATE TABLE `lr_fm_files` (
  ...
  `file_type` enum('image','video','audio','document','archive','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'other',
  `size` bigint UNSIGNED NOT NULL,
  `disk` enum('local','public','s3') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'public',
...
--
ALTER TABLE `lr_language`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=790;
...
--
-- Constraints for table `lr_fm_files`
--
ALTER TABLE `lr_fm_files`
  ADD CONSTRAINT `lr_fm_files_folder_id_foreign` FOREIGN KEY (`folder_id`) REFERENCES `lr_fm_folders` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `lr_fm_folders`
--
ALTER TABLE `lr_fm_folders`
  ADD CONSTRAINT `lr_fm_folders_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `lr_fm_folders` (`id`) ON DELETE CASCADE;
