...
--
-- Host: localhost:3306
-- Generation Time: Oct 03, 2025 at 10:08 AM
...
CREATE TABLE `lr_cover_image` (
  ...
  `cover_slideshow_direction` enum('horizontal','vertical') NOT NULL DEFAULT 'horizontal',
  `cover_is_active` enum('active','inactive') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'active',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
