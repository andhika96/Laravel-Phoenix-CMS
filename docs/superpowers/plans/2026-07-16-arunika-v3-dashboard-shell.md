...
- Keep the header and page content inside one rounded `.ph-layout-right` canvas; the inner `.ph-main-panel` must not add its own gutter, border, radius, or shadow.
