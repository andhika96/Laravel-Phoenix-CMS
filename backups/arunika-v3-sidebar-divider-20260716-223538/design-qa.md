...
- Spacing and layout rhythm: source-aligned `160px` sidebar, `52px` header, `220px` search, `8px` outer canvas gutter, `12px` canvas radius, and inherited content padding (`24px 22px 32px` desktop; `18px 14px 28px` responsive) are verified from runtime DOM measurements.
