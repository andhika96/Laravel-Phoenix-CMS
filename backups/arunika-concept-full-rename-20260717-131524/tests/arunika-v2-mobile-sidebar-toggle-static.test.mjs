...
const layout = readFileSync(
    'resources/views/themes/arunika_v2/cms/cms_layout.blade.php',
    'utf8',
);
const css = readFileSync(
    'public/assets/css/themes/arunika_v2/arunika_v2.css',
    'utf8',
);
...
console.log('Arunika v2 mobile sidebar close-toggle regression passed.');
