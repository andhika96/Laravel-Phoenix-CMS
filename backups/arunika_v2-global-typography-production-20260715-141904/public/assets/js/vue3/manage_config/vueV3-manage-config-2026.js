...
const SiteConfigVue3 = createApp(
{
	...
	methods:
	{
		...
		initSiteTypographySettings: function()
		{
			...
			this.responseData.font_family = this.responseData.font_family || DEFAULT_FONT_FAMILY;
		...
		{
			return this.responseData.font_family || DEFAULT_FONT_FAMILY;
		},
		...
		{
			this.responseData.font_family = DEFAULT_FONT_FAMILY;
