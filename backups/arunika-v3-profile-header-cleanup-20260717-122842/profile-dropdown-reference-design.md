...
- Show a compact user summary at the top with the existing dynamic avatar, full name, current role, and chevron.
- Use consistent 40px menu rows with existing Font Awesome icons and restrained hover states.
- Separate the user summary, primary actions, and Logout with lightweight dividers.
