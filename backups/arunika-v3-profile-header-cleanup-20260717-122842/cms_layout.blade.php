@include('themes.arunika_v3.components.menu')
...
<html lang="en" style="--ph-font-family: '{{ $siteFontFamilyName }}', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; --ph-font-size: {{ $siteFontSize }};">
	<head>
		...
		<link href="{{ asset('assets/css/themes/arunika_v3/arunika_v3.css?v=').time() }}" rel="stylesheet">
	...
	<body class="ph-theme-arunika-v3">
						...
						<div class="dropdown ph-sidebar-profile">
							...
							<div class="dropdown-menu ph-header-profile-menu ph-sidebar-profile-menu">
								<div class="ph-profile-menu-user">
									...
									<i class="fal fa-chevron-down ph-profile-menu-chevron" aria-hidden="true"></i>
								</div>
		...
		<script src="{{ url('assets/js/themes/arunika_v3/arunika_v3.js?v=').time() }}"></script>
	</body>
</html>
