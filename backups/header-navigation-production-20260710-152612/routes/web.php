	...
	->group(function() 
	{
		...
		*/
		...
		Route::controller(\Awesome_Admin_Menu_FE_Controller::class)->group(function()
		{
			...
			Route::post('/menu/fe/update_parentmenu/dropdown', 'update_parentmenu_dropdown')->name('awesome_admin.menu.fe.update_parentmenu.dropdown')->middleware('auth', 'checkSuspended');
			...
			Route::get('/menu/fe/listdata/parentmenu/dropdown/{parentCode}', 'listDataParentMenuDropdown')->name('awesome_admin.menu.fe.listdata.parentmenu.dropdown')->middleware('auth', 'checkSuspended');
