			...
			<div class="ph-sidebar ph-no-transition" id="sidebar">
				...
				<div id="sidebar-scroll-content">
					...
					<div class="list-group list-group-flush w-100">
						<div class="ph-nav-category ph-nav-category-static">
							<span class="ph-nav-category-label">{{ t('Workspace') }}</span>
							<span class="ph-nav-category-initial">W</span>
						</div>
				...
				<div class="ph-sidebar-footer">
					<div class="ph-list-group-wrapper">
						<a href="{{ url('awesome_admin') }}" class="list-group-item list-group-item-action">
							<div class="ph-nav-icon"><i class="fal fa-cog fa-fw"></i></div>
							<span class="ph-nav-text">{{ t('Settings') }}</span>

							<div class="ph-custom-tooltip"><span>{{ t('Settings') }}</span></div>
						</a>

						<div class="dropdown ph-sidebar-palette-wrapper">
							<button class="list-group-item list-group-item-action" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
								<div class="ph-nav-icon"><i class="fal fa-palette fa-fw"></i></div>
								<span class="ph-nav-text">{{ t('Appearance') }}</span>
								<div class="ph-custom-tooltip"><span>{{ t('Appearance') }}</span></div>
							</button>

							<div class="dropdown-menu ph-sidebar-palette p-3">
								<h6 class="dropdown-header px-0 text-start">{{ t('Theme Color') }}</h6>
								<div class="row g-2" id="color-picker-container"></div>
							</div>
						</div>

						<button class="list-group-item list-group-item-action ph-sidebar-theme-toggle" type="button" onclick="toggleTheme()" aria-pressed="false">
							<div class="ph-nav-icon"><i class="fas fa-sun ph-sidebar-theme-icon"></i></div>
							<span class="ph-nav-text">{{ t('Dark Mode') }}</span>
							<span class="ph-sidebar-theme-switch" aria-hidden="true"></span>
							<div class="ph-custom-tooltip"><span>{{ t('Dark Mode') }}</span></div>
						</button>
					</div>
			...
			<div class="ph-layout-right" id="ph-layout-right">
				<div class="ph-top-bar" id="ph-top-bar">
					...
					<div class="ph-header-actions">
						<a href="{{ url('awesome_admin') }}" class="ph-btn-action-icon" title="{{ t('Help') }}" aria-label="{{ t('Help') }}">
