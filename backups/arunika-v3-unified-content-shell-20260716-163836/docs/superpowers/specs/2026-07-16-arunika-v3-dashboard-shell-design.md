...
- Sidebar uses a calm near-white gray surface with a subtle right divider.
...
- Main content uses a warm near-white background. Existing page content and cards retain their own layout and behavior.
