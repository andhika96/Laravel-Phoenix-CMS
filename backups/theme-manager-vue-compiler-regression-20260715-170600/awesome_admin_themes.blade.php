		...
		<div class="ph-notice" v-cloak>
			<div class="toast-container position-fixed top-0 end-0 p-3">
				<div ref="noticeToast" :class="'toast ph-notice-toast ph-callout-no-border '+responseStatus" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="3200">
					...
					<div class="toast-body p-3 text-start" v-text="responseMessage"></div>
				</div>
			</div>
		</div>
								...
								<article
									...
									<div class="theme-manager-card-body">
										<div class="theme-manager-title-line">
											...
											<span class="theme-manager-status"><span class="theme-manager-status-dot"></span><span v-text="themeStatus('{{ $theme['code'] }}')">{{ $activeThemeCode === $theme['code'] ? t('Active') : t('Available') }}</span></span>
										</div>
			...
			<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
				<div class="modal-content">
					<div class="modal-header">
						<div>
							<h5 class="modal-title" id="themeManagerPreviewTitle" v-text="previewTheme ? previewTheme.name+' preview' : '{{ t('Theme preview') }}'"></h5>
