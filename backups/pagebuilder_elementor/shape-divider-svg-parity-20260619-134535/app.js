(function () {
	...
	const NODE_LABEL_ICONS = Object.freeze({
		...
		container_fluid: 'fa-solid fa-cube',
		row_grid: 'fa-solid fa-table-cells-large',
		grid: 'fa-solid fa-table-cells-large',
		heading: 'fa-solid fa-heading',
		text_editor: 'fa-solid fa-pen-to-square',
	...
	function nodeLabelIcon(type) {
		return NODE_LABEL_ICONS[type] || 'fa-solid fa-cube';
	}
...
>
	...
	<div class="pb-node-content" :style="contentShellStyle" @click.stop="onSelect(node)">
			...
			<component :is="loadWidget(node.type)" :item="node" :responsive-device="responsiveDevice">
				<div class="el-cont-columns" :style="contColumnsStyle">
					...
					>
						...
						>
							<span class="pb-grid-col-label-badge"><i class="fa-regular fa-square"></i></span>
						...
						>
							...
							<template #footer>
								<div v-if="!col.children || col.children.length === 0" class="pb-dropzone-empty pb-grid-col-empty-hint">
									<button v-if="!isSequentialColumnLocked(ci)" type="button" class="pb-inline-add" @click.stop.prevent="onShowToolbox()">
	...
	createApp({
		...
		setup() {
			...
			const responsiveDevices = [
				{ value: 'desktop', label: 'Desktop', menuLabel: 'Desktop', icon: 'fa-solid fa-desktop' },
				{ value: 'tablet', label: 'Tablet', menuLabel: 'Tablet Portrait', icon: 'fa-solid fa-tablet-screen-button' },
				{ value: 'mobile', label: 'Mobile', menuLabel: 'Mobile Portrait', icon: 'fa-solid fa-mobile-screen-button' },
			];
			...
			const shapeDividerTypeOptions = [
				...
				{ value: 'tilt-opacity', label: 'Tilt Opacity' },
				{ value: 'fan-opacity', label: 'Fan Opacity' },
				{ value: 'curve', label: 'Curve' },
				{ value: 'curve-asymmetrical', label: 'Curve Asymmetrical' },
				{ value: 'waves', label: 'Waves' },
				{ value: 'waves-brush', label: 'Waves Brush' },
			...
			function selectNode(n)  { clearSelectedColumn(); selectedId.value = n.id; }
			function clearSel()     { clearSelectedColumn(); selectedId.value = ''; }
			...
			return {
				...
				shapeDividerTypeOptions, shapeDividerWidthValue, shapeDividerWidthUnit, setShapeDividerWidthValue, setShapeDividerWidthUnit,
			...
			<div v-if="!selectedNode">
				<div class="pb-section">
					...
					<div class="pb-form-group mt-3">
						...
						<button type="button" class="pb-css-editor-trigger" @click="openCustomCssEditor">
							<span class="pb-css-editor-trigger-main"><i class="fa-solid fa-code"></i> Custom CSS Editor</span>
							<span class="pb-css-editor-trigger-action"><i class="fa-solid fa-up-right-from-square"></i></span>
						</button>
					</div>
				</div>
				...
				<div class="pb-section" v-if="selectedColumnContext">
					<div class="pb-props-header">
						<button class="pb-btn icon-sm" @click="clearCurrentSelection" title="Back"><i class="fa-solid fa-chevron-left"></i></button>
						...
						<div v-show="settingsTab==='layout'" class="pb-tab-content">
							...
							<details class="pb-collapsible" v-if="selectedNode.settings.displayType==='flex'||!selectedNode.settings.displayType" open>
								...
								<div class="pb-form-group">
									...
									<div class="pb-btn-group">
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'direction','row')==='row'}"            @click="setContainerResponsiveSetting(selectedNode.settings,'direction','row')"            title="Row"><i class="fa-solid fa-arrow-right"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'direction','row')==='column'}"         @click="setContainerResponsiveSetting(selectedNode.settings,'direction','column')"         title="Column"><i class="fa-solid fa-arrow-down"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'direction','row')==='row-reverse'}"    @click="setContainerResponsiveSetting(selectedNode.settings,'direction','row-reverse')"    title="Row Reverse"><i class="fa-solid fa-arrow-left"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'direction','row')==='column-reverse'}" @click="setContainerResponsiveSetting(selectedNode.settings,'direction','column-reverse')" title="Col Reverse"><i class="fa-solid fa-arrow-up"></i></button>
									</div>
								</div>
								<div class="pb-form-group">
									<div class="pb-label-row pb-label-row-device">
									...
									<div class="pb-btn-group">
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'justifyContent','flex-start')==='flex-start'}"    @click="setContainerResponsiveSetting(selectedNode.settings,'justifyContent','flex-start')"    title="Start"><i class="fa-solid fa-align-left"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'justifyContent','flex-start')==='center'}"        @click="setContainerResponsiveSetting(selectedNode.settings,'justifyContent','center')"        title="Center"><i class="fa-solid fa-align-center"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'justifyContent','flex-start')==='flex-end'}"      @click="setContainerResponsiveSetting(selectedNode.settings,'justifyContent','flex-end')"      title="End"><i class="fa-solid fa-align-right"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'justifyContent','flex-start')==='space-between'}" @click="setContainerResponsiveSetting(selectedNode.settings,'justifyContent','space-between')" title="Space Between"><i class="fa-solid fa-arrows-left-right-to-line"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'justifyContent','flex-start')==='space-around'}"  @click="setContainerResponsiveSetting(selectedNode.settings,'justifyContent','space-around')"  title="Space Around"><i class="fa-solid fa-grip-lines-vertical"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'justifyContent','flex-start')==='space-evenly'}"  @click="setContainerResponsiveSetting(selectedNode.settings,'justifyContent','space-evenly')"  title="Space Evenly"><i class="fa-solid fa-grip"></i></button>
									</div>
								</div>
								<div class="pb-form-group">
									<div class="pb-label-row pb-label-row-device">
									...
									<div class="pb-btn-group">
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'alignItems','flex-start')==='flex-start'}" @click="setContainerResponsiveSetting(selectedNode.settings,'alignItems','flex-start')" title="Start"><i class="fa-solid fa-arrow-up"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'alignItems','flex-start')==='center'}"    @click="setContainerResponsiveSetting(selectedNode.settings,'alignItems','center')"    title="Center"><i class="fa-solid fa-arrows-up-down"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'alignItems','flex-start')==='flex-end'}"  @click="setContainerResponsiveSetting(selectedNode.settings,'alignItems','flex-end')"  title="End"><i class="fa-solid fa-arrow-down"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'alignItems','flex-start')==='stretch'}"   @click="setContainerResponsiveSetting(selectedNode.settings,'alignItems','stretch')"   title="Stretch"><i class="fa-solid fa-arrows-up-down-left-right"></i></button>
									</div>
								</div>
								<div class="pb-form-group">
									<div class="pb-label-row pb-label-row-device">
								...
								<div class="pb-form-group">
									...
									<div class="pb-btn-group">
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'flexWrap','nowrap')==='nowrap'}" @click="setContainerResponsiveSetting(selectedNode.settings,'flexWrap','nowrap')" title="No Wrap"><i class="fa-solid fa-right-long"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'flexWrap','nowrap')==='wrap'}" @click="setContainerResponsiveSetting(selectedNode.settings,'flexWrap','wrap')" title="Wrap"><i class="fa-solid fa-turn-down"></i></button>
									</div>
								...
								<div class="pb-form-group" v-if="containerResponsiveValue(selectedNode.settings,'flexWrap','nowrap')==='wrap' || containerResponsiveValue(selectedNode.settings,'flexWrap','nowrap')==='wrap-reverse'">
									...
									<div class="pb-btn-group">
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'alignContent','stretch')==='flex-start'}"    @click="setContainerResponsiveSetting(selectedNode.settings,'alignContent','flex-start')"    title="Start"><i class="fa-solid fa-align-left"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'alignContent','stretch')==='center'}"        @click="setContainerResponsiveSetting(selectedNode.settings,'alignContent','center')"        title="Center"><i class="fa-solid fa-align-center"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'alignContent','stretch')==='flex-end'}"      @click="setContainerResponsiveSetting(selectedNode.settings,'alignContent','flex-end')"      title="End"><i class="fa-solid fa-align-right"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'alignContent','stretch')==='space-between'}" @click="setContainerResponsiveSetting(selectedNode.settings,'alignContent','space-between')" title="Space Between"><i class="fa-solid fa-arrows-left-right-to-line"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'alignContent','stretch')==='space-around'}"  @click="setContainerResponsiveSetting(selectedNode.settings,'alignContent','space-around')"  title="Space Around"><i class="fa-solid fa-grip-lines-vertical"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'alignContent','stretch')==='stretch'}"       @click="setContainerResponsiveSetting(selectedNode.settings,'alignContent','stretch')"       title="Stretch"><i class="fa-solid fa-left-right"></i></button>
									</div>
								</div>
								</div>
							</details>
							<details class="pb-collapsible" v-if="selectedNode.settings.displayType==='grid'" open>
								...
								<div class="pb-form-group">
									...
									<div class="pb-btn-group">
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'gridJustifyItems','stretch')==='start'}" @click="setContainerResponsiveSetting(selectedNode.settings,'gridJustifyItems','start')" title="Start"><i class="fa-solid fa-align-left"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'gridJustifyItems','stretch')==='center'}" @click="setContainerResponsiveSetting(selectedNode.settings,'gridJustifyItems','center')" title="Center"><i class="fa-solid fa-align-center"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'gridJustifyItems','stretch')==='end'}" @click="setContainerResponsiveSetting(selectedNode.settings,'gridJustifyItems','end')" title="End"><i class="fa-solid fa-align-right"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'gridJustifyItems','stretch')==='stretch'}" @click="setContainerResponsiveSetting(selectedNode.settings,'gridJustifyItems','stretch')" title="Stretch"><i class="fa-solid fa-left-right"></i></button>
									</div>
								</div>
								<div class="pb-form-group">
									<div class="pb-label-row pb-label-row-device">
									...
									<div class="pb-btn-group">
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'gridAlignItems','start')==='start'}" @click="setContainerResponsiveSetting(selectedNode.settings,'gridAlignItems','start')" title="Start"><i class="fa-solid fa-arrow-up"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'gridAlignItems','start')==='center'}" @click="setContainerResponsiveSetting(selectedNode.settings,'gridAlignItems','center')" title="Center"><i class="fa-solid fa-arrows-up-down"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'gridAlignItems','start')==='end'}" @click="setContainerResponsiveSetting(selectedNode.settings,'gridAlignItems','end')" title="End"><i class="fa-solid fa-arrow-down"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings,'gridAlignItems','start')==='stretch'}" @click="setContainerResponsiveSetting(selectedNode.settings,'gridAlignItems','stretch')" title="Stretch"><i class="fa-solid fa-arrows-up-down-left-right"></i></button>
									</div>
								</div>
								</div>
							</details>
						...
						<div v-show="settingsTab==='advanced'" class="pb-tab-content">
							<details class="pb-collapsible" open>
								...
								<div class="pb-form-group">
									...
									<div class="pb-btn-group">
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings, 'alignSelf', 'auto')==='auto'}" @click="setContainerResponsiveSetting(selectedNode.settings, 'alignSelf', 'auto')" title="Auto"><i class="fa-solid fa-minus"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings, 'alignSelf', 'auto')==='flex-start'}" @click="setContainerResponsiveSetting(selectedNode.settings, 'alignSelf', 'flex-start')" title="Start"><i class="fa-solid fa-arrow-up"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings, 'alignSelf', 'auto')==='center'}" @click="setContainerResponsiveSetting(selectedNode.settings, 'alignSelf', 'center')" title="Center"><i class="fa-solid fa-arrows-up-down"></i></button>
								...
								<div class="pb-form-group">
									...
									<div class="pb-btn-group">
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings, 'order', '')==='-1'}" @click="setContainerResponsiveSetting(selectedNode.settings, 'order', '-1')" title="Start"><i class="fa-solid fa-arrow-left"></i></button>
								...
								<div class="pb-form-group">
									...
									<div class="pb-btn-group">
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings, 'sizeMode', 'default')==='default'}" @click="setContainerResponsiveSetting(selectedNode.settings, 'sizeMode', 'default')" title="Default"><i class="fa-solid fa-ban"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings, 'sizeMode', 'default')==='grow'}" @click="setContainerResponsiveSetting(selectedNode.settings, 'sizeMode', 'grow')" title="Grow"><i class="fa-solid fa-arrows-left-right"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings, 'sizeMode', 'default')==='shrink'}" @click="setContainerResponsiveSetting(selectedNode.settings, 'sizeMode', 'shrink')" title="Shrink"><i class="fa-solid fa-compress"></i></button>
										<button class="pb-seg-btn" :class="{active:containerResponsiveValue(selectedNode.settings, 'sizeMode', 'default')==='custom'}" @click="setContainerResponsiveSetting(selectedNode.settings, 'sizeMode', 'custom')" title="Custom"><i class="fa-solid fa-ellipsis"></i></button>
									</div>
								</div>
								<div class="pb-form-group">
								...
								<div class="pb-form-group">
									<div class="pb-label-row">
										...
										<button class="pb-field-action-btn" type="button" title="Display Conditions" @click="showUnsupportedControlNotice('Display Conditions', 'Display Conditions panel belum tersedia di builder ini. Untuk saat ini yang aktif baru hide per device.')"><i class="fa-solid fa-sitemap"></i></button>
									</div>
			...
			<div class="pb-stage-window" @click.stop="closeWidthPreviewMenu()">
				<div class="pb-stage-toolbar">
					<div class="pb-stage-device-group">
						<button class="pb-stage-device-btn" :class="{ active: responsiveDevice==='mobile' }" @click="setResponsiveDevice('mobile')" title="Mobile"><i class="fa-solid fa-mobile-screen-button"></i></button>
						<button class="pb-stage-device-btn" :class="{ active: responsiveDevice==='tablet' }" @click="setResponsiveDevice('tablet')" title="Tablet"><i class="fa-solid fa-tablet-screen-button"></i></button>
						<button class="pb-stage-device-btn" :class="{ active: responsiveDevice==='desktop' }" @click="setResponsiveDevice('desktop')" title="Desktop"><i class="fa-solid fa-desktop"></i></button>
					</div>
					<div class="pb-stage-width-control" @click.stop>
						...
						<div v-if="responsiveDevice==='desktop' && widthPreviewMenuOpen" class="pb-stage-width-menu">
							<button v-for="option in desktopPreviewWidths" :key="'desktop-width-'+option.value" type="button" class="pb-stage-width-option" :class="{ active: desktopPreviewWidth===option.value }" @click="selectDesktopPreviewWidth(option.value)">
								...
								<i v-if="desktopPreviewWidth===option.value" class="fa-solid fa-check"></i>
							</button>
						</div>
					</div>
				</div>
		...
		<div v-if="showCssEditor" class="pb-css-editor-modal" @click.self="closeCustomCssEditor">
			<div class="pb-css-editor-panel" :class="{ fullscreen: cssEditorFullscreen }">
				<div class="pb-css-editor-header">
					<div class="pb-css-editor-title"><i class="fa-solid fa-code"></i><span>Custom CSS Editor</span></div>
					<div class="pb-css-editor-actions">
						<button type="button" class="pb-css-editor-icon-btn" :title="cssEditorFullscreen ? 'Exit fullscreen' : 'Fullscreen'" @click="cssEditorFullscreen = !cssEditorFullscreen">
							<i class="fa-solid" :class="cssEditorFullscreen ? 'fa-compress' : 'fa-expand'"></i>
						</button>
						<button type="button" class="pb-css-editor-icon-btn danger" title="Close" @click="closeCustomCssEditor"><i class="fa-solid fa-xmark"></i></button>
					</div>
				</div>
				<div class="pb-css-editor-body">
					...
					<div class="pb-css-editor-toolbar">
						<form class="pb-css-editor-tool" @submit.prevent="goToCustomCssLine">
							...
							<button type="submit" class="pb-css-editor-tool-btn" title="Go to line"><i class="fa-solid fa-arrow-down-short-wide"></i></button>
						</form>
						<div class="pb-css-editor-tool is-search">
							...
							<button type="button" class="pb-css-editor-tool-btn" title="Find now" @click="searchCustomCssCode(true)"><i class="fa-solid fa-magnifying-glass"></i></button>
						</div>
					</div>
		...
		<div v-if="showTextEditorModal && selectedType==='text_editor' && selectedNode" class="pb-rte-editor-modal" @click.self="closeTextEditorModal">
			<div class="pb-rte-editor-panel" :class="{ fullscreen: textEditorModalFullscreen }">
				<div class="pb-rte-editor-header">
					<div class="pb-rte-editor-title"><i class="fa-solid fa-pen-to-square"></i><span>Text Editor</span></div>
					<div class="pb-rte-editor-actions">
						<button type="button" class="pb-rte-editor-icon-btn" :title="textEditorModalFullscreen ? 'Exit fullscreen' : 'Fullscreen'" @click="textEditorModalFullscreen = !textEditorModalFullscreen">
							<i class="fa-solid" :class="textEditorModalFullscreen ? 'fa-compress' : 'fa-expand'"></i>
						</button>
						<button type="button" class="pb-rte-editor-icon-btn danger" title="Close" @click="closeTextEditorModal"><i class="fa-solid fa-xmark"></i></button>
					</div>
				</div>
				...
				<div class="pb-rte-editor-footer">
					<div class="pb-rte-editor-count"><i class="fa-solid fa-font"></i> {{ textEditorModalSummary }}</div>
					<div class="pb-rte-editor-footer-actions">
						<button type="button" class="pb-rte-editor-btn primary" @click="closeTextEditorModal"><i class="fa-solid fa-check"></i> Apply & Close</button>
					</div>
				</div>
			</div>
		</div>
