...
<html lang="en">
	...
	<body>
			...
			<div class="ph-sidebar ph-no-transition" id="sidebar">
				...
				<div class="ph-sidebar-logo-container" onclick="toggleSidebar()">
					...
					<button class="ph-mobile-sidebar-close" type="button" onclick="event.stopPropagation(); toggleSidebar()" aria-label="{{ t('Close navigation') }}">
						<svg class="ph-mobile-sidebar-close-icon" viewBox="0 0 24 24" aria-hidden="true">
							<rect x="2.75" y="2.75" width="18.5" height="18.5" rx="4"></rect>
							<path d="M8.25 3.25V20.75"></path>
							<path class="ph-mobile-sidebar-close-chevron" d="M16 8.75L12.75 12L16 15.25"></path>
						</svg>
					</button>
				</div>
		...
		<script src="{{ url('assets/js/themes/arunika_mosaic/arunika_mosaic.js?v=').time() }}"></script>
	</body>
</html>
