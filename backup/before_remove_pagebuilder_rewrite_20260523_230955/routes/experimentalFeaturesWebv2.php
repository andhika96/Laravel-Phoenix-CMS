...
/* New Page Builder Rewrite (Isolated MVC) */

Route::controller(App\Http\Controllers\Web\PageBuilderRewrite\PageBuilderRewrite_Controller::class)->group(function()
{
	Route::get('/pagebuilder-rewrite', 'index')->name('cms.core.pagebuilder_rewrite');

	Route::get('/pagebuilder-rewrite/create', 'create')->name('cms.core.pagebuilder_rewrite.create');
	Route::post('/pagebuilder-rewrite/store', 'store')->name('cms.core.pagebuilder_rewrite.store');

	Route::get('/pagebuilder-rewrite/edit/{idOrSlug}', 'edit')->name('cms.core.pagebuilder_rewrite.edit');
	Route::post('/pagebuilder-rewrite/update/{idOrSlug}', 'update')->name('cms.core.pagebuilder_rewrite.update');

	Route::get('/pagebuilder-rewrite/data/{idOrSlug}', 'getData')->name('cms.core.pagebuilder_rewrite.data');
});
