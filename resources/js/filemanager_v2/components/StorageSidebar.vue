...
const folderTree = computed(() => {
  ...
  (props.folders ?? []).forEach((folder) => {
    nodesByPath.set(folder.path, { ...folder, children: [] });
  });

  nodesByPath.forEach((folder) => {
    const parent = nodesByPath.get(parentPath(folder.path));
