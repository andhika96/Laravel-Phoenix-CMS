...
@section('content')
    <div class="mb-3">{{ Breadcrumbs::render('manage_event.edit') }}</div>
    <div class="ph-content rounded p-3 mb-3"><h4 class="mb-0"><i class="fad fa-calendar-edit fa-fw me-1"></i>{{ t('Edit Event') }}</h4></div>
    @include('manage_event.partials.form', ['event' => $event, 'categories' => $categories])
@endsection
