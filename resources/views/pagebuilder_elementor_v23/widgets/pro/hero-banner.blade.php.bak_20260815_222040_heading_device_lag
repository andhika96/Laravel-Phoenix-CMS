...
<style>
#{{ $heroId }}{min-height:{{ $heroLength($heroResponsive('minHeight','','500px'),'500px') }};--hero-content-gap:{{ $heroLength($heroResponsive('contentGap','','14px'),'14px') }};--hero-title-size:{{ $heroLength($heroResponsive('titleFontSize','','48px'),'48px') }};--hero-subtitle-size:{{ $heroLength($heroResponsive('subtitleFontSize','','22px'),'22px') }}}
...
@media(max-width:1024px){#{{ $heroId }}{min-height:{{ $heroLength($heroResponsive('minHeight','Tablet','520px'),'520px') }};--hero-content-gap:{{ $heroLength($heroResponsive('contentGap','Tablet','14px'),'14px') }};--hero-title-size:{{ $heroLength($heroResponsive('titleFontSize','Tablet','38px'),'38px') }};--hero-subtitle-size:{{ $heroLength($heroResponsive('subtitleFontSize','Tablet','18px'),'18px') }}}#{{ $heroId }} .pb-hero-banner__media{object-fit:{{ $heroEnum($heroResponsive('objectFit','Tablet','cover'),['cover','contain','fill'],'cover') }};object-position:{{ $heroObjectPosition('Tablet','center center') }}}#{{ $heroId }} .pb-hero-banner__buttons{ {{ $heroButtonLayout('Tablet') }} }@if($heroMode==='grouped')#{{ $heroId }} .pb-hero-banner__content{ {{ $heroPosition('group','Tablet') }} }@else @foreach(['title','subtitle','buttons'] as $target)#{{ $heroId }} .pb-hero-banner__block--{{ $target }}{ {{ $heroPosition($target,'Tablet') }} }@endforeach @endif}
@media(max-width:767px){#{{ $heroId }}{min-height:{{ $heroLength($heroResponsive('minHeight','Mobile','680px'),'680px') }};--hero-content-gap:{{ $heroLength($heroResponsive('contentGap','Mobile','10px'),'10px') }};--hero-title-size:{{ $heroLength($heroResponsive('titleFontSize','Mobile','34px'),'34px') }};--hero-subtitle-size:{{ $heroLength($heroResponsive('subtitleFontSize','Mobile','17px'),'17px') }}}#{{ $heroId }} .pb-hero-banner__media{object-fit:{{ $heroEnum($heroResponsive('objectFit','Mobile','cover'),['cover','contain','fill'],'cover') }};object-position:{{ $heroObjectPosition('Mobile','center top') }}}#{{ $heroId }} .pb-hero-banner__buttons{ {{ $heroButtonLayout('Mobile') }} }@if($heroMode==='grouped')#{{ $heroId }} .pb-hero-banner__content{ {{ $heroPosition('group','Mobile') }} }@else @foreach(['title','subtitle','buttons'] as $target)#{{ $heroId }} .pb-hero-banner__block--{{ $target }}{ {{ $heroPosition($target,'Mobile') }} }@endforeach @endif}
</style>
