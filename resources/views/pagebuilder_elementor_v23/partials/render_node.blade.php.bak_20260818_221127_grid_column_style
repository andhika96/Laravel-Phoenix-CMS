@php
	...
	$__pbConditionEvaluator = app(\App\Support\PageBuilderElementorV23\WidgetDisplayConditionEvaluator::class);
	...
	if (in_array($type, ['accordion', 'image_box', 'icon_box', 'image_carousel', 'basic_gallery', 'icon_list', 'heading'], true) && ($settings['cacheMode'] ?? 'default') === 'active') {
		...
		$__pbFragmentCache = app(\App\Support\PageBuilderElementorV23\WidgetFragmentCache::class);
		$__pbFragmentView = match ($type) {
			'image_box' => 'pagebuilder_elementor_v23.partials.render_image_box',
			'icon_box' => 'pagebuilder_elementor_v23.partials.render_icon_box',
			'image_carousel' => 'pagebuilder_elementor_v23.partials.render_image_carousel',
			'basic_gallery' => 'pagebuilder_elementor_v23.partials.render_basic_gallery',
			'icon_list' => 'pagebuilder_elementor_v23.partials.render_icon_list',
			'heading' => 'pagebuilder_elementor_v23.widgets.basic.heading',
			default => 'pagebuilder_elementor_v23.partials.render_accordion',
		};
	...
	$shape_divider_shapes_path = resource_path('data/pagebuilder_elementor_v23_shapes.json');
	...
	$__pbWidgetModule = config('pagebuilder_elementor_v23_widgets.' . $type);
