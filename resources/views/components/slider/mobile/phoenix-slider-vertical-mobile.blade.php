...
<div class="position-relative" id="ph-app-coverimage">
	...
	<div class="splide splide-vertical d-block d-md-none">
		...
		<div class="splide__track">
									...
									@if ($slideshow['disable_content'] == 'inactive')
										<div class="ph-container-fluid-coverimage position-absolute top-0 p-3 w-100 h-100 text-white" style="z-index: 3">
											<div class="container position-relative h-100">
												<div class="position-absolute {{ coverImageContentPositionMobileV($slideshow['desktop_content_position']) }}">
													<div class="row">
														<div class="{{ coverImageContentGridPositionMobileV($slideshow['desktop_content_position']) }}">
										...
										@if ($slideshow['countdown']['mobile_position'] !== 'default')
											<div class="ph-container-fluid-coverimage-2 position-absolute top-0 p-3 w-100 h-100 text-white" style="z-index: 2">
												<div class="container position-relative h-100">
													<div class="position-absolute pe-4 me-1 {{ coverImageContentPositionCountDownMobile($slideshow['countdown']['mobile_position']) }}">
														<div class="row g-3">
															<div class="col-auto">
																@if ($slideshow['countdown']['is_active'] == 'active')
			...
			<ul class="splide__pagination d-flex flex-column"></ul>
		</div>
	</div>
	...
	document.addEventListener('DOMContentLoaded', function() 
	{
		...
		splide.on('active', function(e) 
		{
			...
			// console.log(e.slide.parentElement.offsetParent);
		})
