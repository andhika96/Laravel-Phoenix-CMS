...
@section('title')
	{{ t('Manage Frontend Menu Categories') }}
@endsection

@section('content')
	<div id="ph-app-manage-categorymenu">
		<div class="mb-3">		
			{{ Breadcrumbs::render('awesome_admin.menu.fe.category_menu') }}
		</div>

		<div class="ph-content rounded p-3 mb-3">
			<div class="row g-3">
				<div class="col-md-6 d-flex align-items-center">
					<h4 class="mb-0">{{ t('Manage Frontend Menu Categories') }}</h4>
				</div>
			</div>
		</div>
		...
		<div class="row g-4">
			<div class="col-md-6">
				<div class="ph-content rounded p-4 ph-fetch-listdata-categorymenu" id="ph-fetch-listdata-categorymenu" data-url="{{ url('awesome_admin/menu/fe/listdata/categorymenu') }}">
					...
					<div v-else class="ph-data-load-content" id="ph-form-manage-categorymenu" style="display: none">
						<form action="{{ route('cms.admin.awesome_admin.menu.fe.update_categorymenu') }}" method="post" auto-refresh="false" auto-lock-button="false" custom-button-value="Save" ref="formHTML" @submit.prevent="submitData">
			...
			<div class="col-md-6">
				<div class="ph-content rounded p-4 ph-fetch-listdata-roles" data-url="{{ url('awesome_admin/menu/fe/listdata/roles') }}">
					...
					<div id="ph-submit-data-rp">
						...
						<div class="row g-3 ph-fetch-listdata-routes" data-url="{{ url('awesome_admin/menu/listdata/routes') }}">
			...
			<div class="modal fade" id="modalDeleteCategoryMenu" tabindex="-1" aria-labelledby="modalDeleteCategoryMenuLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content" id="ph-form-delete-categorymenu">
						<form action="{{ url('awesome_admin/menu/delete_categorymenu') }}" method="post" auto-refresh="true" auto-lock-button="true" custom-button-value="<i class='fas fa-trash-alt fa-fw me-1'></i> Delete" ref="formHTMLdelete" @submit="submitDataDelete($event)">
...
@pushonce('js')
	<script src="{{ url('assets/js/vue3/manage_menu/fe/vueV3-manage-frontend-category-menu-2026.js?v=').time() }}"></script>
@endpushonce