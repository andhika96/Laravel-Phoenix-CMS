...
@section('title')
	{{ t('Manage Backend Submenus') }}
@endsection

@section('content')
	<div id="ph-app-manage-menu">
		<div class="mb-3">
			{{ Breadcrumbs::render('awesome_admin.menu.be.submenu') }}
		</div>

		<div class="ph-content rounded p-3 mb-3">
			<div class="row g-3">
				<div class="col-md-6 d-flex align-items-center">
					<h4 class="mb-0">{{ t('Manage Backend Submenus') }}</h4>
				</div>
			</div>
		</div>
		...
		<div class="row g-4">
			<div class="col-md-6">
				<div class="ph-content rounded p-4 ph-fetch-listdata-menu" data-url="{{ url('awesome_admin/menu/be/listdata/submenu') }}">
							...
							<div class="list-group-item px-0" v-for="(element, index) in responseDataMenu" :key="menu_name">
								<div class="row g-1">
									...
									<div class="col-md-6 d-flex align-items-center justify-content-end">
										<a :href="'{{ url('awesome_admin/menu/be/submenu/detail/\'+element.parent_code+\'') }}'" class="btn btn-link text-danger font-size-inherit">View detail</a> |
			...
			<div class="col-md-6">
				<div class="ph-content rounded p-4">
					...
					<div id="ph-form-manage-menu">
						<form action="{{ route('cms.admin.awesome_admin.menu.be.create_submenu') }}" method="post" ref="formHTML" @submit.prevent="submitDataSubmenu">
							...
							<div class="row g-3">
								<div class="col-12 form-group ph-fetch-listdata-parentmenu" data-url="{{ url('awesome_admin/menu/be/listdata/parentmenuforsubmenu') }}">
			...
			<div class="modal ph-modal-delete fade" id="modalDeleteSubmenu" tabindex="-1" aria-labelledby="modalDeleteSubmenuLabel" aria-hidden="true">
				<div class="modal-dialog ph-modal-dialog modal-dialog-centered">
					<div class="modal-content" id="ph-form-delete-submenu">
						<form action="{{ url('awesome_admin/menu/be/delete_submenu') }}" method="post" auto-refresh="true" auto-lock-button="true" custom-button-value="<i class='fas fa-trash-alt fa-fw me-1'></i> {{ t('Delete') }}" ref="formHTMLdelete" @submit="submitDataDeleteParentMenu($event)">
