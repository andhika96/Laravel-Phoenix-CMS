@include('themes.arunika_equinox.components.menu')
				...
				<div class="ph-top-bar" id="ph-top-bar">
					...
					<div class="ph-header-actions">
						...
						<div class="dropdown ph-header-profile">
							<button class="ph-header-user-card" type="button" data-bs-toggle="dropdown" data-bs-display="static" data-bs-auto-close="outside" aria-expanded="false" aria-label="{{ t('Open profile menu') }}">
								<span class="ph-header-user-avatar">{!! get_avatar('no_frame', 'rounded-circle', 36) !!}</span>
								<span class="ph-header-user-meta">
									<strong>{{ auth()->user()->fullname }}</strong>
