...
function initProCarousel(root) { bindProSlider(root, true); }
	...
	function init(scope) {
		...
		root.querySelectorAll("[data-pro-carousel].pb-pro-testimonial-carousel").forEach(initProCarousel);
	}

	const runtimes = window.PageBuilderElementorV24ModuleRuntimes ||= {};
	runtimes["testimonial_carousel"] = Object.freeze({ init, initProCarousel });
