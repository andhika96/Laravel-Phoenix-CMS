    ...
    >
        ...
        <div v-if="editor.settingsTab === 'style'" class="pb-tab-content">
                ...
                <section-box title="Sections">
                    ...
                    <color-control v-if="s.sectionBackgroundType === 'classic'" label="Background" v-model="s.sectionBackground" />
                    <template v-if="s.sectionBackgroundType === 'gradient'">
                        <color-control label="Gradient Color One" v-model="s.sectionGradientColorOne" />
                        <color-control label="Gradient Color Two" v-model="s.sectionGradientColorTwo" />
                        <number-control label="Gradient Angle" v-model="s.sectionGradientAngle" :min="0" :max="360" />
                    </template>
