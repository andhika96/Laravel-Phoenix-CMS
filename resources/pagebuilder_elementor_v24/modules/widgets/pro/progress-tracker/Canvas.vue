...
export default {
    ...
    computed: {
        ...
        progressTrackerIndicatorAlignment() {
            return this.safeEnum(this.s.indicatorAlignment, ["left", "center", "right"], "left");
        },
        ...
        progressTrackerIndicatorStyle() {
            return {
                ...
                marginLeft: this.progressTrackerIndicatorAlignment === "right" ? "auto" : this.progressTrackerIndicatorAlignment === "center" ? "auto" : "0",
                marginRight: this.progressTrackerIndicatorAlignment === "center" ? "auto" : "0",
            };
        },
