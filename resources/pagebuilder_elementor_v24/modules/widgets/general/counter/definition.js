(function (registry) {
	...
	const shared = () => registry.advancedDefaults();
	...
	const defaults = () => ({
		...
		titleFontFamily: 'inherit', titleFontSizeMode: 'auto', titleFontSize: '16px', titleFontSizeTablet: '', titleFontSizeMobile: '', titleFontWeight: '500', titleTextTransform: 'none', titleFontStyle: 'normal', titleTextDecoration: 'none', titleLineHeight: '1.4em', titleLineHeightTablet: '', titleLineHeightMobile: '', titleLetterSpacing: '0px', titleLetterSpacingTablet: '', titleLetterSpacingMobile: '', titleWordSpacing: '0px', titleWordSpacingTablet: '', titleWordSpacingMobile: '',
	});
	registry.register({type: 'counter',defaults,normalize(node) {
