...
export default {
	...
	computed:{
		...
		safeLinkUrl(){const url=String(this.resolveDynamicValue('linkUrl',this.settings.linkUrl||'')).trim();return /^(?:https?:|mailto:|tel:)/i.test(url)||url.startsWith('/')||url.startsWith('#')?url:'';},
