(function () {
	...
	window.PageBuilderElementorV23Runtime = Object.freeze({ init, bindAccordion, bindImageCarousel, bindBasicGallery, bindAdvancedWidget, initProSlides, initProCarousel, initProCountdown, initProHotspot, initProFlipBox, initProForm, initProAnimatedHeadline });
