(function () {
	...
	function init(scope) {
		...
		rootScope.querySelectorAll('[data-tabs-widget]').forEach(initTabs);
	...
	window.PageBuilderElementorV23Runtime = Object.freeze({ init, bindAccordion, bindImageCarousel, bindBasicGallery, bindBasicImage, initTabs, bindAdvancedWidget, openMediaLightbox, initProSlides, initProCarousel, initProCountdown, initProProgressTracker, initProVideoPlaylist, initProHotspot, initProFlipBox, initProForm, initProAnimatedHeadline, initProCodeHighlight, initProShareButtons, initHeroBanner, initProductColorSelector, initHeroSlider });
