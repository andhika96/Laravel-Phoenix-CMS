(function (registry) {
	...
	registry.register({
		...
		canvas: '/js/pagebuilder_elementor_v23/widgets/general/social-icons/Canvas.vue', settings: '/js/pagebuilder_elementor_v23/widgets/general/social-icons/Settings.vue', defaults,
		normalize(node) {
