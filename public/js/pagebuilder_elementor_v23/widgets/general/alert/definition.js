(function (registry) {
	...
	registry.register({
		...
		canvas: '/js/pagebuilder_elementor_v23/widgets/general/alert/Canvas.vue', settings: '/js/pagebuilder_elementor_v23/widgets/general/alert/Settings.vue', defaults,
		normalize(node) {
