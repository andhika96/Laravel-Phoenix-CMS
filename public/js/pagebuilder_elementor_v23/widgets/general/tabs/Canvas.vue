	...
	computed: {
		...
		rootStyle() {
			...
			const style = {
				...
				'--pb-tabs-nav-border-style': this.enumValue('tabsNavBorderType', ['none', 'solid', 'double', 'dotted', 'dashed', 'groove'], 'none'),
				'--pb-tabs-nav-border-width': this.boxValue('tabsNavBorderWidth', '0px'),
				'--pb-tabs-nav-border-color': this.cssColor(this.responsiveValue('tabsNavBorderColor', 'transparent'), 'transparent'),
