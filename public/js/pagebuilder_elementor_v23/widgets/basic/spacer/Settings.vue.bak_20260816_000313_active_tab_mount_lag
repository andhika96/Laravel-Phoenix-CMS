<template>
	<div class="pb-widget-settings pb-widget-settings--basic pb-widget-settings--spacer">
		...
		<div v-show="editor.settingsTab === 'advanced'" class="pb-tab-content">
			<details class="pb-collapsible" open><summary>Attributes</summary><div class="pb-collapsible-body"><div class="pb-form-group"><label class="pb-form-label">CSS Class</label><input class="pb-input" v-model="node.settings.cssClass" placeholder="custom-spacer"></div></div></details>
		</div>
	</div>
</template>
