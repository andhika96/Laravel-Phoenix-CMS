...
export default {
    ...
    methods: {
        ...
        formDatasetOptions(field) {
            const datasets = Array.isArray(window.PAGE_BUILDER_ELEMENTOR_V23_FORM_DATASETS)
                ? window.PAGE_BUILDER_ELEMENTOR_V23_FORM_DATASETS
                : [];
