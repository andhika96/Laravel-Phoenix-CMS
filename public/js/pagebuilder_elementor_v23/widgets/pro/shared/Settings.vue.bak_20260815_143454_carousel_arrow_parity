        ...
        <div v-show="editor.settingsTab === 'content'" class="pb-tab-content">
            ...
            <template v-else-if="type === 'carousel'">
                <section-box title="Slides" :open="true"
                    ...
                    ><responsive-number
                        ...
                        :editor="editor"
                        :min="1"
                        :max="8" /><number-control
                        label="Slides on scroll"
                        v-model="s.slidesToScroll"
                        :min="1"
            ...
            <template v-else-if="type === 'reviews'">
                ...
                <section-box title="Additional Options" :open="true"
                    ><toggle-control
                        label="Arrows"
                        v-model="s.arrows" /><select-control
                        label="Pagination"
                        v-model="s.pagination"
        ...
        <div v-show="editor.settingsTab === 'style'" class="pb-tab-content">
            ...
            <template v-else-if="type === 'slides'">
                ...
                <section-box title="Navigation"
                    ><select-control
                        ...
                        v-model="s.arrowsPosition"
                        :options="insideOutsideOptions" /><size-control
                        label="Arrows Size"
                        base="arrowsSize"
                        fallback="24px"
                        :node="node"
                        :editor="editor" /><color-control
                        label="Arrows Color"
                        v-model="s.arrowsColor" /><select-control
                        label="Dots Position"
                        v-model="s.dotsPosition"
                        :options="insideOutsideOptions" /><size-control
                        label="Dots Size"
                        base="dotsSize"
                        fallback="8px"
                        ...
                        :editor="editor" /><color-control
                        label="Dots Color"
                        v-model="s.dotsColor" /><color-control
                        label="Active Color"
                        v-model="s.dotsActiveColor"
                /></section-box>
            </template>
            <template v-else-if="type === 'animated_headline'">
                <section-box
            ...
            <template v-else-if="type === 'carousel'">
                ...
                <section-box title="Navigation"
                    ><color-control
                        label="Arrow Color"
                        v-model="s.arrowColor" /><color-control
                        label="Arrow Background"
                        v-model="s.arrowBackground"
                /></section-box>
                <section-box title="Pagination"
                    ><color-control
                        label="Color"
                        v-model="s.paginationColor" /><color-control
                        label="Active Color"
                        v-model="s.paginationActiveColor"
                /></section-box>
            </template>
            <template v-else-if="type === 'media_carousel'">
                <section-box title="Slides" :open="true">
                ...
                <section-box title="Navigation"
                    ><template v-if="s.arrows"
                        ...
                        <size-control
                            ...
                            :node="node"
                            :editor="editor"
                            :max="100" /><color-control
                            label="Color"
                            v-model="s.arrowColor" /></template
