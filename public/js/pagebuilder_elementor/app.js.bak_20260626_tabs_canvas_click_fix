						...
						<div v-show="settingsTab==='advanced'" class="pb-tab-content pb-layout-settings__tab">
							<details class="pb-collapsible" open>
								...
								<div class="pb-form-group">
									...
									<div class="pb-label-row">
										<div></div>
										<button class="pb-link-btn" @click="selectedNode.settings.marginLinked=!selectedNode.settings.marginLinked" :title="selectedNode.settings.marginLinked?'Unlink':'Link'"><i :class="selectedNode.settings.marginLinked?'fas fa-link':'fas fa-unlink'"></i></button>
									</div>
								...
								<div class="pb-form-group">
									...
									<div class="pb-label-row">
										<div></div>
										<button class="pb-link-btn" @click="selectedNode.settings.paddingLinked=!selectedNode.settings.paddingLinked" :title="selectedNode.settings.paddingLinked?'Unlink':'Link'"><i :class="selectedNode.settings.paddingLinked?'fas fa-link':'fas fa-unlink'"></i></button>
									</div>
									<div class="pb-four-sides mt-1">
