(function (registry) {
	...
	const runtime = () => window.PageBuilderElementorComplexWidgetRuntime?.icon_box;
	registry.register({
		type: 'icon_box', label: 'Icon Box', category: 'general', icon: 'far fa-star', toolbox: true,
		canvas: '/js/pagebuilder_elementor/widgets/general/icon-box/Canvas.vue',
		settings: '/js/pagebuilder_elementor/widgets/general/icon-box/Settings.vue',
