(function (registry) {
	...
	const runtime = () => window.PageBuilderElementorComplexWidgetRuntime?.icon_list;
	registry.register({
		type: 'icon_list', label: 'Icon List', category: 'general', icon: 'fas fa-list-ul', toolbox: true,
		canvas: '/js/pagebuilder_elementor/widgets/general/icon-list/Canvas.vue',
		settings: '/js/pagebuilder_elementor/widgets/general/icon-list/Settings.vue',
