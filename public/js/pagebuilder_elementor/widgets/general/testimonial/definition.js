(function (registry) {
	...
	registry.register({
		...
		canvas: '/js/pagebuilder_elementor/widgets/general/testimonial/Canvas.vue', settings: '/js/pagebuilder_elementor/widgets/general/testimonial/Settings.vue', defaults,
		normalize(node) {
