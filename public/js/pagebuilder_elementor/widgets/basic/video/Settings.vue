	...
	<div class="pb-widget-settings pb-widget-settings--basic pb-widget-settings--video">
		...
		<div v-show="editor.settingsTab === 'style'" class="pb-tab-content">
			<details class="pb-collapsible" open>
				...
				<div class="pb-collapsible-body">
					<div v-if="editor.videoUsesControlsColor(node)" class="pb-form-group"><label class="pb-form-label">Controls Color</label><div class="pb-color-row"><input type="color" class="pb-color-swatch" v-model="node.settings.controlsColor"><input class="pb-input coloris pb-coloris-input" v-model="node.settings.controlsColor" placeholder="#ff3366"></div></div>
