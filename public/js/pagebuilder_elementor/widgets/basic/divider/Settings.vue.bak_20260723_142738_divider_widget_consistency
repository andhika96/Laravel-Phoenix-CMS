<template>
	<div class="pb-widget-settings pb-widget-settings--basic pb-widget-settings--divider">
		<div class="pb-widget-settings__group">
			<div class="pb-form-group"><label class="pb-form-label">Style</label><select class="pb-select" v-model="node.settings.style"><option value="solid">Solid</option><option value="dashed">Dashed</option><option value="dotted">Dotted</option></select></div>
			...
			<div class="pb-form-group"><label class="pb-form-label">Thickness</label><input class="pb-input" v-model.number="node.settings.thickness" type="number"></div>
		...
		<div class="pb-widget-settings__group pb-widget-settings__group--advanced"><div class="pb-form-group"><label class="pb-form-label">CSS Class</label><input class="pb-input" v-model="node.settings.cssClass" placeholder="custom-divider"></div></div>
	</div>
</template>
