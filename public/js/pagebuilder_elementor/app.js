						...
						<div class="pb-image-box-settings pb-widget-settings pb-widget-settings--image-box">
							...
							<div v-show="settingsTab==='style'" class="pb-tab-content pb-image-box-style-settings">
								<details class="pb-collapsible" open>
									<summary>Box</summary>
									<div class="pb-collapsible-body">
										<div class="pb-form-group pb-image-box-choice-row"><div class="pb-label-row pb-label-row-device"><label class="pb-form-label mb-0">Image Position</label><div class="pb-control-device-wrap"><button type="button" class="pb-control-device-btn" @click.stop="openControlResponsiveMenu('image-box-position')" :title="'Responsive: ' + responsiveDeviceLabel()"><i :class="responsiveDeviceIcon()"></i></button><div v-if="isControlResponsiveMenuOpen('image-box-position')" class="pb-control-device-menu"><button v-for="device in responsiveDevices" :key="'image-box-position-'+device.value" type="button" class="pb-control-device-item" :class="{active:responsiveDevice===device.value}" @click.stop="applyResponsiveDevice('image-box-position', device.value)"><i :class="device.icon"></i><span>{{ deviceOptionLabel(device) }}</span></button></div></div></div><div class="pb-btn-group pb-image-box-segmented pb-image-box-segmented--three"><button v-for="option in [{value:'left',icon:'fas fa-arrow-left'},{value:'top',icon:'fas fa-arrow-up'},{value:'right',icon:'fas fa-arrow-right'}]" :key="'image-box-position-option-'+option.value" type="button" class="pb-seg-btn" :class="{active:selectedNode.settings[activeResponsiveKey('imagePosition')]===option.value}" :aria-pressed="selectedNode.settings[activeResponsiveKey('imagePosition')]===option.value" :title="option.value" @click.prevent="selectedNode.settings[activeResponsiveKey('imagePosition')]=option.value"><i :class="option.icon"></i></button></div></div>
										<div class="pb-form-group pb-image-box-choice-row"><div class="pb-label-row pb-label-row-device"><label class="pb-form-label mb-0">Alignment</label><div class="pb-control-device-wrap"><button type="button" class="pb-control-device-btn" @click.stop="openControlResponsiveMenu('image-box-alignment')" :title="'Responsive: ' + responsiveDeviceLabel()"><i :class="responsiveDeviceIcon()"></i></button><div v-if="isControlResponsiveMenuOpen('image-box-alignment')" class="pb-control-device-menu"><button v-for="device in responsiveDevices" :key="'image-box-alignment-'+device.value" type="button" class="pb-control-device-item" :class="{active:responsiveDevice===device.value}" @click.stop="applyResponsiveDevice('image-box-alignment', device.value)"><i :class="device.icon"></i><span>{{ deviceOptionLabel(device) }}</span></button></div></div></div><div class="pb-btn-group pb-image-box-segmented pb-image-box-segmented--four"><button v-for="option in [{value:'left',icon:'fas fa-align-left'},{value:'center',icon:'fas fa-align-center'},{value:'right',icon:'fas fa-align-right'},{value:'justify',icon:'fas fa-align-justify'}]" :key="'image-box-alignment-option-'+option.value" type="button" class="pb-seg-btn" :class="{active:selectedNode.settings[activeResponsiveKey('alignment')]===option.value}" :aria-pressed="selectedNode.settings[activeResponsiveKey('alignment')]===option.value" :title="option.value" @click.prevent="selectedNode.settings[activeResponsiveKey('alignment')]=option.value"><i :class="option.icon"></i></button></div></div>
