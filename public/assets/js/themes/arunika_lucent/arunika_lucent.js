...
const lucentSidebarToggle = document.getElementById('ph-lucent-sidebar-toggle');
...
function updateSidebarToggleState()
{
	...
	if (lucentSidebarToggle)
	{
		lucentSidebarToggle.setAttribute('aria-expanded', isExpanded ? 'true' : 'false');
		lucentSidebarToggle.setAttribute('aria-label', isExpanded ? 'Hide sidebar' : 'Show sidebar');
		lucentSidebarToggle.title = isExpanded ? 'Hide sidebar' : 'Show sidebar';
	}
