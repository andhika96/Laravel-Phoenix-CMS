...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/contents/ckfinder/userfiles/',
...
$config['backends'][] = array(
    ...
    'root'          => 'contents/ckfinder/userfiles',
    'baseUrl'       => 'https://mgmotorid-assets.s3.ap-southeast-3.amazonaws.com/contents/ckfinder/userfiles/',
);
...
/* Disable by Andhika Adhitia N
$config['resourceTypes'][] = array(
    'name'              => 'Files', // Single quotes not allowed.
    'directory'         => 'files',
    'maxSize'           => 0,
    'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,svg,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,webp,xls,xlsx,zip',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
*/
