...
test('v24 owns an isolated core plus complete manifest-discovered module tree', () => {
  ...
  assert.deepEqual(activeFiles(v24Root), ['app.js', 'frontend-runtime.js', 'vue-draggable-plus.iife.js', 'widget-registry.js']);
  ...
  assert.equal(modules.length, 49, 'all v2.4 Layout, Grid, and Widget modules must be discoverable');
