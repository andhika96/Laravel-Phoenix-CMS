...
test('Page Builder editor redesign v2.3 uses one contextual sidebar', () => {
    const html = readFileSync(v23Path, 'utf8');
...
test('Page Builder editor redesign v2.3 switches the left sidebar between Elements and selected settings', () => {
    const html = readFileSync(v23Path, 'utf8');
