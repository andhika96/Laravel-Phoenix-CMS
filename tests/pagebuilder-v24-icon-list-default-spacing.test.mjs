...
test('Icon List v2.4 keeps the requested default spacing across editor and frontend layers', () => {
	const app = read('public/js/pagebuilder_elementor_v24/app.js');
	const settings = read('resources/pagebuilder_elementor_v24/modules/widgets/general/icon-list/Settings.vue');
	const canvas = read('resources/pagebuilder_elementor_v24/modules/widgets/general/icon-list/Canvas.vue');
	const frontend = read('resources/pagebuilder_elementor_v24/modules/widgets/general/icon-list/frontend.blade.php');
