...
const gridSettingsPath = path.join(root, 'public/js/pagebuilder_elementor_v23/widgets/layout/grid/Settings.vue');
const rowGridSettingsPath = path.join(root, 'public/js/pagebuilder_elementor_v23/widgets/layout/row-grid/Settings.vue');
