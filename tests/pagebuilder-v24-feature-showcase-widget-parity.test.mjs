...
const definition = read('resources/pagebuilder_elementor_v24/modules/widgets/general/feature-showcase/definition.js');
const app = definition;
const settings = read('resources/pagebuilder_elementor_v24/modules/widgets/general/feature-showcase/Settings.vue');
const canvas = read('resources/pagebuilder_elementor_v24/modules/widgets/general/feature-showcase/Canvas.vue');
const blade = read('resources/pagebuilder_elementor_v24/modules/widgets/general/feature-showcase/frontend.blade.php');
const manifest = JSON.parse(read('resources/pagebuilder_elementor_v24/modules/widgets/general/feature-showcase/module.json'));
...
assert.equal(manifest.type, 'feature_showcase');
assert.equal(manifest.label, 'Feature Showcase');
...
for (const template of templates) {
	assert.match(definition, new RegExp(template), `module definition must know ${template}`);
...
console.log('pagebuilder v2.4 feature showcase widget parity test passed');
