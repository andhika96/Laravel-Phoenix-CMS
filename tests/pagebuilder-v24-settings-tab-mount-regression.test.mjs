...
const settingsSources = {
  'Hero Slider': readFileSync(
    `${root}/resources/pagebuilder_elementor_v24/modules/widgets/pro/hero-slider/Settings.vue`,
    'utf8',
  ),
  'Product Color Selector': readFileSync(
    `${root}/resources/pagebuilder_elementor_v24/modules/widgets/pro/product-color-selector/Settings.vue`,
    'utf8',
  ),
};
