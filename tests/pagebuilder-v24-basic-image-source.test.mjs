...
test('v2.4 Image defaults legacy nodes to CKFinder and switches to an external URL without clearing src', async () => {
...
test('v2.4 Image canvas renders the canonical external settings.src', async () => {
...
test('v2.0 Image settings remain isolated from the v2.4 source selector', async () => {
