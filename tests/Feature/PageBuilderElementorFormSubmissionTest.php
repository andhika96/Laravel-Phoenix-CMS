...
class PageBuilderElementorFormSubmissionTest extends TestCase
{
    ...
    public function test_saved_form_executes_collect_email_email2_webhook_and_returns_redirect(): void
    {
        ...
        $response = $this->postJson('/pagebuilder-elementor/form/contact-page/form-contact', [
            'name' => 'Aruna',
        ...
        Mail::assertSent(PageBuilderElementorFormMail::class, 2);
        Mail::assertSent(PageBuilderElementorFormMail::class, function (PageBuilderElementorFormMail $mail): bool {
    ...
    public function test_form_submission_rejects_unknown_nodes_and_private_webhook_targets(): void
    {
        ...
        $this->postJson('/pagebuilder-elementor/form/contact-page/missing-node', [
            'name' => 'Aruna',
            'email' => 'aruna@example.com',
        ])->assertNotFound();

        $this->postJson('/pagebuilder-elementor/form/contact-page/form-contact', [
            'name' => 'Aruna',
            'email' => 'aruna@example.com',
    ...
    public function test_saved_option_numeric_and_file_constraints_cannot_be_bypassed(): void
    {
        ...
        $response = $this->withHeader('Accept', 'application/json')->post(
            '/pagebuilder-elementor/form/contact-page/form-contact',
            [
                'plan' => 'enterprise',
                'score' => '99',
    ...
    public function test_saved_form_renderer_exposes_only_its_server_submit_endpoint(): void
    {
        ...
        $submitUrl = route('cms.core.pagebuilder_elementor.form.submit', [
    ...
    private function createPageWithForm(array $settings): void
    {
        $form = [
            'id' => 'form-contact',
            'type' => 'form',
