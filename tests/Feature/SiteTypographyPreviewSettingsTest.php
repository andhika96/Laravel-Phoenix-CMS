...
class SiteTypographyPreviewSettingsTest extends TestCase
{
	public function test_site_config_uses_existing_vue_select_with_live_typography_preview(): void
	{
		...
		$this->assertStringContainsString('class="fas fa-font-case"', $view);
		$this->assertStringContainsString('.site-typography-heading-icon i', $view);
		$this->assertStringContainsString('.site-settings-subheading .site-typography-heading-icon', $view);
