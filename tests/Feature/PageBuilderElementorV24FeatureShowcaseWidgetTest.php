...
class PageBuilderElementorV24FeatureShowcaseWidgetTest extends TestCase
{
    ...
    {
        $module = $this->pageBuilderV24Module('feature_showcase');
    ...
    public function test_specifications_metrics_supports_four_metrics_and_centered_third_metric(): void
    {
        ...
        $threeMetricHtml = $this->pageBuilderV24ModuleView($module, [
            'node' => [
        ...
        $oneMetricHtml = $this->pageBuilderV24ModuleView($module, [
            'node' => [
    ...
    public function test_frontend_renderer_accepts_direct_asset_image_urls_and_rejects_unsafe_urls(): void
    {
        ...
        $unsafeHtml = $this->pageBuilderV24ModuleView($module, [
            'node' => [
    ...
    public function test_specifications_metrics_support_responsive_metric_columns_and_third_position_gate_contract(): void
    {
        ...
        $fourMetricHtml = $this->pageBuilderV24ModuleView($module, [
            'node' => [
