...
const gridSettings = fs.readFileSync(path.join(root, 'resources/pagebuilder_elementor_v24/modules/layout/grid/Settings.vue'), 'utf8');
const containerSettings = fs.readFileSync(path.join(root, 'resources/pagebuilder_elementor_v24/modules/layout/container/Settings.vue'), 'utf8');
const gridBlade = fs.readFileSync(path.join(root, 'resources/pagebuilder_elementor_v24/modules/layout/grid/frontend.blade.php'), 'utf8');
const containerBlade = fs.readFileSync(path.join(root, 'resources/pagebuilder_elementor_v24/modules/layout/container/frontend.blade.php'), 'utf8');
