...
const canvas = readFileSync(
    `${root}/resources/pagebuilder_elementor_v24/modules/widgets/pro/video-playlist/Canvas.vue`,
    'utf8',
);

test('Video Playlist item title style is a callable method in its module Canvas', () => {
